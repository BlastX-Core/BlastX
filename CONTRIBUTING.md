Contributing to BlastX Core
==================================

The BlastX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BlastX Core project, and is not to be
confused with overall BlastX Network Protocol consensus changes.

Whether a pull request is merged into BlastX Core rests with the project merge
...
Patches that change BlastX consensus rules are considerably more involved than
...
Where a patch set proposes to change the BlastX consensus, it must have been
...
The project leader is the release manager for each BlastX Core release.
