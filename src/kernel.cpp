...
int nStakeTargetSpacing = 60; // Blastx: 1 minute blocks during POS (block 201+)
...
{
    // Blastx will hash in the transaction hash and the index number in order to make sure each hash is unique
