...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"blastx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"blastx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"blastx", "masternodedebug", &masternodedebug, true, true, false},
        {"blastx", "startmasternode", &startmasternode, true, true, false},
        {"blastx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"blastx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"blastx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"blastx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"blastx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"blastx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"blastx", "mnbudget", &mnbudget, true, true, false},
        {"blastx", "preparebudget", &preparebudget, true, true, false},
        {"blastx", "submitbudget", &submitbudget, true, true, false},
        {"blastx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"blastx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"blastx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"blastx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"blastx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"blastx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"blastx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"blastx", "checkbudgets", &checkbudgets, true, true, false},
        {"blastx", "mnsync", &mnsync, true, true, false},
        {"blastx", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> blastx-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:30008/\n";
}
