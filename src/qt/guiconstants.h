...
/* Blastx GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Blastx"
#define QAPP_ORG_DOMAIN "blastexchange.com"
#define QAPP_APP_NAME_DEFAULT "Blastx-Qt"
#define QAPP_APP_NAME_TESTNET "Blastx-Qt-testnet"
