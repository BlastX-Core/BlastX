...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a BLASTX address (e.g. %1)").arg("D7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
#endif
...
{
    // return if URI is not valid or is no blastx: URI
...
{
    // Convert blastx:// to blastx:
    //
    //    Cannot handle this later, because blastx:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open blastx.conf with the associated application */
...
{
    return GetAutostartDir() / "blastx.desktop";
}
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the blastx app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add blastx app to startup item list
