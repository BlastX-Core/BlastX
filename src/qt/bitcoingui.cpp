                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BlastX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BLASTX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and blastx: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BlastX Core"), this);
    aboutAction->setStatusTip(tr("Show information about BlastX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BlastX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BLASTX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BLASTX addresses"));
    ...
    openAction->setStatusTip(tr("Open a blastx: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BlastX Core help message to get a list with possible BlastX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BlastX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BlastX network", "", count));
}
...
{
    QString strTitle = tr("BlastX Core"); // default title
