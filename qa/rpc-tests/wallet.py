...
#   c) node1 mines 32 blocks, so now node 0 has 500000BLASTX, node 1 has 4250BLASTX, node2 has none.
#   d) node0 sends 601 BLASTX to node2, in two transactions (301 BLASTX, then 300 BLASTX).
