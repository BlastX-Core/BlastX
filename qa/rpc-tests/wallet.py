...
#   c) node1 mines 32 blocks, so now node 0 has 500000BLAST, node 1 has 4250BLAST, node2 has none.
#   d) node0 sends 601 BLAST to node2, in two transactions (301 BLAST, then 300 BLAST).
