...
This mechanism has been integrated into Bitcore-Node-BlastX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BlastXBLASTX/insight-api-blastx#web-socket-api](https://github.com/BlastXBLASTX/insight-api-blastx#web-socket-api)
* API: [https://github.com/BlastXBLASTX/insight-api-blastx#swifttx-transactions](https://github.com/BlastXBLASTX/insight-api-blastx#swifttx-transactions)
...
By default, the BlastX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BlastX Core daemon:
