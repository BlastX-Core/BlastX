...
Intro
-----
BlastX (BLASTX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. BlastX utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run blastx-qt.exe.

BlastX Core is the original BlastX client and it builds the backbone of the network.
However, it downloads and stores the entire history of BlastX transactions;
