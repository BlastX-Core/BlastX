...
In order to support loading of multiple wallets in blastx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is blastx.cpp.
...
Changes to blastx.cpp
----------------------
blastx.cpp is the entry point into blastx-qt, and as such, will require some minor modifications to provide hooks for
